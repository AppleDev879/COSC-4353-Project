...
const Navbar = ({logout, user}) => {
  ...
  return (
    <NavBar>
        ...
        <List>
            <ListItem>
                <Avatar src={user.photos[0].value} alt={user.photos} />
            </ListItem>
            ...
            <ListItem>
                <Avatar src='https://images.pexels.com/photos/1704488/pexels-photo-1704488.jpeg' alt='Default Picture' />
            </ListItem>
            <ListItem>Default User</ListItem>
            <ListItem onClick={logout}>Logout</ListItem>
        </List>)}
    </NavBar>
  )
